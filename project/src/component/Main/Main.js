        ...
        <main className="main">
            ...
            <section className="best-selling-section _container">
                <div className="section__box">
                    ...
                    <div className="best-selling-section__menu section__menu">
                        <h2 className="section__menu-caption caption_h2">Best selling products</h2>
                        <ul className="section__menu-list">
                            ...
                            <li className="section__menu-list-item"><a href="#">Special nutrition</a></li>
                            <li className="section__menu-list-item"><a href="#">Pharmacy</a></li>
                            <li className="section__menu-list-item"><a href="#">Baby</a></li>
                        ...
                        <button className="section__menu-button btn btn-label" data-button-name="products">More
                            products</button>
                    </div>


                    <div className="best-selling-section__content section__content">
            ...
            <section className="farmers-section _container">
                <div className="section__box">

                    <div className="farmers-section__menu section__menu">
                        <h2 className="section__menu-caption caption_h2">Best from Farmers</h2>
                        <ul className="section__menu-list">
                            <li className="section__menu-list-item"><a href="#">Carrots</a></li>
                            <li className="section__menu-list-item"><a href="#">Tomatoes</a></li>
                            <li className="section__menu-list-item"><a href="#">Potatoes</a></li>
                            <li className="section__menu-list-item"><a href="#">Chicken</a></li>
                            <li className="section__menu-list-item"><a href="#">Pork</a></li>
                            <li className="section__menu-list-item hidden"><a href="#">Flour</a></li>
                            <li className="section__menu-list-item hidden"><a href="#">Nuts</a></li>
                        </ul>
                        <button className="section__menu-button btn btn-label" data-button-name="products">More
                            products</button>
                    </div>
                    ...
                    <div className="farmers-section__content section__content">
                        <div className="section__content-card">
                            <div className="section__content-card-picture">
                                <img className="section__content-card-picture-img" src="img/product-title.jpg"
                                    alt="product"/></div>
